...
const HowTo = () => {
  return (
    <section className="hero bg-neutral min-h-screen flex flex-col justify-center items-center py-8">
      <h1 className="text-4xl font-bold uppercase text-primary">
        how to place an order?
      </h1>
      <div className="hero-content flex-col lg:flex-row gap-8 pt-8">
        <article className="mockup-phone">
          <div className="camera"></div>
          <div className="display">
            <div className="artboard artboard-demo phone-1 bg-white">
              <img src={logo} alt="logo" className="w-full max-w-lg" />
            </div>
          </div>
        </article>
        <article className="grid md:grid-cols-2 gap-6">
          <div className="flex flex-col gap-3 justify-center items-center">
            ...
            <p className="font-light text-lg">"Select your residence"</p>
          </div>
          <div className="flex flex-col gap-3 justify-center items-center">
            ...
            <p className="font-light text-lg">
              "Select fast food or restaurant"
            </p>
          </div>
          <div className="flex flex-col gap-3 justify-center items-center">
          ...
          <div className="flex flex-col gap-3 justify-center items-center">
            ...
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="icon icon-tabler icons-tabler-outline icon-tabler-moped"
            >
            ...
            <p className="font-light text-lg">"Out for delivery"</p>
          </div>
        </article>
      </div>
    </section>
